            ...
            <form action="">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Почта или логин</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Почта или логин">
                    </div>
                    <div class="form-group">
